    ...
    return <>
        <footer className="flex justify-center items-center bg-gray-800 w-full flex-col">
            ...
            <div className="w-full flex justify-center items-center bg-gray-900 py-4 text-white">
                <h2 className="text-white my-text font-light text-center">Copyright © 2024 - 2025. All Rights Reserved. konceptsoftwaresolutions.com {!path.pathname.match("landing") ? "| Privacy Policy" : ""}</h2>
            </div>
        </footer>
    </>
}
